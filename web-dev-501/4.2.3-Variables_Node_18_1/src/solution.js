/*
  The following functions were written with `let` instead of `let` and `const`. Keep the functions working but remove all instances of `var` from the code. You should not need to change any other code!
